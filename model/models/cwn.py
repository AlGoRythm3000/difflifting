...
class CWN(BaseModel):
    def __init__(self, in_channels, hidden_channels, out_channels, n_layers=2, **kwargs):
        super().__init__(in_channels, hidden_channels, out_channels)
        self.cwn = TopoCWN(in_channels, in_channels, in_channels, hidden_channels, n_layers=n_layers, **kwargs)
